...
const Experience = () => {
  ...
  return (
    <section ref={sectionRef} id="experience" className="py-32 relative overflow-hidden">
      ...
      />
      <motion.div
        className="absolute inset-0 bg-[radial-gradient(circle_at_60%_40%,rgba(123,47,247,0.12),transparent_50%)]"
        style={{
      ...
      />
      <motion.div
        className="absolute inset-0 bg-[radial-gradient(circle_at_40%_60%,rgba(0,245,255,0.1),transparent_50%)]"
        style={{
      ...
      />
      <motion.div
        className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(255,0,128,0.08),transparent_60%)]"
        style={{
