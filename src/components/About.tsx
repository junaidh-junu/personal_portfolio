  ...
  return (
    <section id="about" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute w-96 h-96 bg-accent-purple/10 rounded-full blur-3xl top-0 right-0" />
        <div className="absolute w-96 h-96 bg-primary/10 rounded-full blur-3xl bottom-0 left-0" />
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4 text-gray-400 leading-relaxed">
              ...
              <p>
                Currently pursuing my <span className="text-primary font-semibold">Master's in Computer Science</span> at
                Griffith College Dublin, I specialize in mobile and web development with expertise in
                <span className="text-primary font-semibold"> Flutter, Kotlin, MERN stack, Django</span>, and more.
              </p>
              <p>
                As a <span className="text-primary font-semibold">Team Lead at D4DX Innovations</span>, I've successfully
              ...
              <p>
                Beyond coding, I'm experienced in <span className="text-primary font-semibold">server management, DNS
