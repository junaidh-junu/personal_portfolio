  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute w-96 h-96 bg-accent-purple/20 rounded-full blur-3xl top-1/2 -right-48 animate-float" style={{ animationDelay: '2s' }} />
        <div className="absolute w-96 h-96 bg-accent-pink/20 rounded-full blur-3xl -bottom-48 left-1/2 animate-float" style={{ animationDelay: '4s' }} />
      </div>
        ...
        >
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3 bg-primary text-dark-bg rounded-lg font-semibold hover:bg-primary-light transition-all duration-300 glow-effect-hover"
            >
              Get In Touch
            </motion.a>
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3 glass glass-hover rounded-lg font-semibold"
            >
              View Projects
            </motion.a>
          </motion.div>
