            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <div className="flex flex-col items-start md:items-end gap-2">
                  <span className="px-4 py-1.5 bg-neutral-800 text-white text-sm font-semibold rounded-full border border-neutral-700">
                    {edu.period}
                  </span>
                  {edu.status && (
                    <span className="px-3 py-1 bg-neutral-800 text-neutral-300 text-xs font-semibold rounded-full border border-neutral-700">
                      {edu.status}
                    </span>
                  )}
                </div>
              ...
              {/* Description */}
              {edu.description && (
                <p className="text-neutral-400 leading-relaxed mb-4">{edu.description}</p>
              )}
