...
export const skills: Skill[] = [
  ...
  { name: 'HTML5', category: 'Languages', level: 5 },
  { name: 'CSS', category: 'Languages', level: 5 },

  // Frameworks
  { name: 'Flutter', category: 'Frameworks', level: 5 },
  ...
  { name: 'MongoDB', category: 'Frameworks', level: 4 },
  { name: 'Mongoose', category: 'Frameworks', level: 4 },
  { name: 'Redux', category: 'Frameworks', level: 3 },
  { name: 'Jetpack Compose', category: 'Frameworks', level: 3 },
  { name: 'Bloc', category: 'Frameworks', level: 4 },
  { name: 'GetX', category: 'Frameworks', level: 4 },
  { name: 'Riverpod', category: 'Frameworks', level: 3 },

  // Tools
  { name: 'Git', category: 'Tools', level: 5 },
  { name: 'GitHub', category: 'Tools', level: 5 },
  { name: 'Firebase', category: 'Tools', level: 4 },
  { name: 'REST APIs', category: 'Tools', level: 5 },
  { name: 'Axios', category: 'Tools', level: 4 },
  { name: 'Figma', category: 'Tools', level: 3 },
  { name: 'Xcode', category: 'Tools', level: 3 },
  { name: 'SQLite', category: 'Tools', level: 3 },
  { name: 'PostgreSQL', category: 'Tools', level: 4 },
  { name: 'PostGIS', category: 'Tools', level: 4 },
  { name: 'MySQL', category: 'Tools', level: 3 },
  { name: 'Prisma', category: 'Tools', level: 3 },
  { name: 'Supabase', category: 'Tools', level: 4 },
  { name: 'Appwrite', category: 'Tools', level: 3 },
  { name: 'Directus', category: 'Tools', level: 3 },
  { name: 'Mapbox', category: 'Tools', level: 4 },
  { name: 'Provider', category: 'Tools', level: 4 },
  { name: 'Android Studio', category: 'Tools', level: 4 },
  { name: 'Play Console', category: 'Tools', level: 3 },
  { name: 'App Store Connect', category: 'Tools', level: 3 },
  { name: 'Postman', category: 'Tools', level: 4 },
  { name: 'Redux Toolkit', category: 'Tools', level: 3 },
  { name: 'VS Code', category: 'Tools', level: 5 },
  { name: 'CDN', category: 'Tools', level: 3 },

  // Cloud & DevOps
  { name: 'Cloudflare', category: 'Cloud & DevOps', level: 4 },
  { name: 'DigitalOcean', category: 'Cloud & DevOps', level: 4 },
  { name: 'Cloudways', category: 'Cloud & DevOps', level: 4 },
  { name: 'Docker', category: 'Cloud & DevOps', level: 3 },
  { name: 'Google Cloud Platform', category: 'Cloud & DevOps', level: 3 },
  { name: 'Vercel', category: 'Cloud & DevOps', level: 4 },
  { name: 'Netlify', category: 'Cloud & DevOps', level: 4 },
  { name: 'WHM/cPanel', category: 'Cloud & DevOps', level: 4 },
  { name: 'Shorebird OTA', category: 'Cloud & DevOps', level: 3 },
  { name: 'GitHub Actions', category: 'Cloud & DevOps', level: 4 },
  { name: 'DNS Management', category: 'Cloud & DevOps', level: 4 },
  { name: 'CI/CD Pipeline', category: 'Cloud & DevOps', level: 4 },

  // Project Management
  { name: 'Jira', category: 'Project Management', level: 3 },
  { name: 'Trello', category: 'Project Management', level: 4 },
  { name: 'Notion', category: 'Project Management', level: 4 },
  { name: 'ClickUp', category: 'Project Management', level: 3 },
  { name: 'Slack', category: 'Project Management', level: 4 },
  ...
  { name: 'Pandas', category: 'AI/ML', level: 3 },
  { name: 'NumPy', category: 'AI/ML', level: 3 },
  { name: 'Jupyter Notebooks', category: 'AI/ML', level: 3 },
];
